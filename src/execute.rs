...
use crate::msg::{ExecuteMsg, InstantiateMsg, MintMsg, MetaAccess};
use crate::state::{Approval, Cw721Contract, TokenInfo};

const CONTRACT_NAME: &str = "crates.io:dnft-contracts";
const CONTRACT_VERSION: &str = env!("CARGO_PKG_VERSION");

impl<'a, T, C> Cw721Contract<'a, T, C>
where
    T: Serialize + DeserializeOwned + Clone + MetaAccess,
    C: CustomMsg,
{
    pub fn instantiate(
        &self,
    ...
    C: CustomMsg,
{
    ...
    pub fn mint(
        ...
        let is_derivative = msg.extension.is_derivative();
        ...
        if info.sender != minter {
            ...
            if !is_derivative {
                ...
                let meta = msg.extension.get_metadata();
                if let Some(derivative) = &meta.derivative {
                    
                    for token_id in derivative.source_ids.iter() {
        ...
        Ok(Response::new()
            ...
            .add_attribute("is_derivative", is_derivative.to_string()))
    }
}
